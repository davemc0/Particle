...
public:
    ...
    PInternalSourceState_t() :
        Up(new PDPoint(P010)), Vel(new PDPoint(P000)), RotVel(new PDPoint(P000)), VertexB(new PDPoint(P000)), Size(new PDPoint(P111)), Color(new PDPoint(P111)),
        Alpha(new PDPoint(P111))
    {
        Data = 0;
        Age = 0.0f;
        AgeSigma = 0.0f;
