...
#ifndef cudadomains_cuh
#define cudadomains_cuh
...
namespace PAPI
{
    ...
    PINLINE pDomain PDData_(PAPI::pDomainType_E Wh,
        unsigned int v00, unsigned int v01, unsigned int v02, unsigned int v03,
        unsigned int v04, unsigned int v05, unsigned int v06, unsigned int v07,
        unsigned int v08, unsigned int v09, unsigned int v0a, unsigned int v0b,
        unsigned int v0c, unsigned int v0d, unsigned int v0e, unsigned int v0f,
        unsigned int v10, unsigned int v11, unsigned int v12, unsigned int v13,
        unsigned int v14, unsigned int v15, unsigned int v16, unsigned int v17,
        unsigned int v18, unsigned int v19, unsigned int v1a, unsigned int v1b,
        unsigned int v1c, unsigned int v1d)
    {
        pDomain D;
        D.Which = Wh;
        D.Varying = false;
        D.PDData_V[0x00] = v00; D.PDData_V[0x01] = v01; D.PDData_V[0x02] = v02; D.PDData_V[0x03] = v03; 
        D.PDData_V[0x04] = v04; D.PDData_V[0x05] = v05; D.PDData_V[0x06] = v06; D.PDData_V[0x07] = v07; 
        D.PDData_V[0x08] = v08; D.PDData_V[0x09] = v09; D.PDData_V[0x0a] = v0a; D.PDData_V[0x0b] = v0b; 
        D.PDData_V[0x0c] = v0c; D.PDData_V[0x0d] = v0d; D.PDData_V[0x0e] = v0e; D.PDData_V[0x0f] = v0f; 
        D.PDData_V[0x10] = v10; D.PDData_V[0x11] = v11; D.PDData_V[0x12] = v12; D.PDData_V[0x13] = v13; 
        D.PDData_V[0x14] = v14; D.PDData_V[0x15] = v15; D.PDData_V[0x16] = v16; D.PDData_V[0x17] = v17; 
        D.PDData_V[0x18] = v18; D.PDData_V[0x19] = v19; D.PDData_V[0x1a] = v1a; D.PDData_V[0x1b] = v1b; 
        D.PDData_V[0x1c] = v1c; D.PDData_V[0x1d] = v1d;
        return D;
    }
    ...
    PINLINE pDomain PDFromVarying_(const PAPI::pDomainType_E Wh, const pVec &v0, const pVec &v1, const pVec &v2, const float f0, const float f1)
    {
        ...
        case PDBlob_e: return PDBlob_(v0, f0);
    ...
    PINLINE pDomain PDLine_Intl(
        const pVec &p0_, const pVec &vec_, const pVec &vecNrm_,
        float len_)
    {
        pDomain D;
        D.Which = PDLine_e;
    ...
    PINLINE pDomain PDTriangle_Intl(
        const pVec &p_, const pVec &u_, const pVec &v_, const pVec &uNrm_, const pVec &vNrm_, const pVec &nrm_, const pVec &s1_, const pVec &s2_,
        float uLen_, float vLen_, float D_, float area_)
    {
        pDomain D;
    ...
    PINLINE pDomain PDRectangle_Intl(
        const pVec &p_, const pVec &u_, const pVec &v_, const pVec &uNrm_, const pVec &vNrm_, const pVec &nrm_, const pVec &s1_, const pVec &s2_,
        float uLen_, float vLen_, float D_, float area_)
    {
        pDomain D;
    ...
    PINLINE pDomain PDDisc_Intl(
        const pVec &p_, const pVec &nrm_, const pVec &u_, const pVec &v_,
        float radIn_, float radOut_, float radInSqr_, float radOutSqr_, float dif_, float D_, float area_)
    {
        pDomain D;
        D.Which = PDDisc_e;
        D.PDDisc_V.p = p_;
    ...
    PINLINE pDomain PDPlane_Intl(
        const pVec &p_, const pVec &nrm_,
        float D_)
    {
        pDomain D;
        D.Which = PDPlane_e;
    ...
    PINLINE pDomain PDBox_Intl(
        const pVec &p0_, const pVec &p1_, const pVec &dif_,
        float vol_)
    {
        pDomain D;
        D.Which = PDBox_e;
    ...
    PINLINE pDomain PDCylinder_Intl(
        const pVec &apex_, const pVec &axis_, const pVec &u_, const pVec &v_,
        float radIn_, float radOut_, float radInSqr_, float radOutSqr_, float radDif_, float axisLenInvSqr_, float vol_,
        bool ThinShell_)
    {
        pDomain D;
    ...
    PINLINE pDomain PDSphere_Intl(
        const pVec &ctr_,
        float radIn_, float radOut_, float radInSqr_, float radOutSqr_, float radDif_, float vol_,
        bool ThinShell_)
    {
        pDomain D;
        D.Which = PDSphere_e;
    ...
    PINLINE pDomain PDBlob_Intl(
        const pVec &ctr_,
        float stdev_, float Scale1_, float Scale2_)
    {
        pDomain D;
        D.Which = PDBlob_e;
        D.PDBlob_V.ctr = ctr_;
