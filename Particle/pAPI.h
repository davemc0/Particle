...
namespace PAPI {
    ...
    public:
        ...
        void Callback(P_PARTICLE_CALLBACK_ACTION callbackFunc, ///< Pointer to function of yours to call. Can be NULL if using only CUDA execution.
            const std::string &callbackStr, ///< The source code of the callback function, which is emitted as part of the kernel. Can be an empty string if not using CUDA execution.
